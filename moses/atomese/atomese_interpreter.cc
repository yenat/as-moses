...
int main() {
	...
	Handle repr = atomese::load_atomese("/home/yenat/as-moses/moses/atomese/test1.csv");
	...
	try {
		...
		throw inst.execute(createLink(PLUS_LINK, createNode(SCHEMA_NODE, "i1"),
